...
var CONTRACT_NAME = "dev-1649819388214-24476130018933" || 'near-hello-world';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/Users/mgimbl", "/.near/validator_key.json"),
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            document.querySelector('#show-greeting').style.display = 'block';
